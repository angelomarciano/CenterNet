...
class WIDER(DETECTION):
    def __init__(self, db_config, split):
        super(WIDER, self).__init__(db_config)
        ...
        self._classes = {#face detection solo una classe
            1: 1
        }
        ...
        self._cache_file = os.path.join(cache_dir, "coco_{}.pkl".format("Prova"))
        self._load_data()
